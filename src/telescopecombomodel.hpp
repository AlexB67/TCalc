...
namespace ScopeCombo
{
  ...
  class ScopeCombomodel
  {
    public:
      ...
      void update_scope_model(const std::tuple<Glib::ustring, double, double, double, double, int, 
                              Glib::ustring, Glib::ustring, Glib::ustring, Glib::ustring, 
                              double, double>& scopedata) const;

      void add_scope_to_model(const std::tuple<Glib::ustring, double, double, double, double, int, 
                              Glib::ustring, Glib::ustring, Glib::ustring, Glib::ustring, 
    ...
    private:
      Glib::RefPtr<Gtk::ListStore>        m_scopetreemodel;
      ...
      void tuple_to_model(const Gtk::TreeRow& row, const std::tuple<Glib::ustring, double, double, 
